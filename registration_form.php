...
<article class="card-body mx-auto" style="max-width: 400px;">
	...
	<select name="countryCode" id="" class="custom-select" style="max-width: 120px;">
		  
	<option data-countryCode="DE" value="49" Selected>DE (+49)</option>
	...
	<optgroup label="Other countries">
		...
		<option data-countryCode="DO" value="1809">Dominican Republic (+1809)</option>
                <option data-countryCode="UK" value="44">England (+44)</option>
...
if(isset($_POST['user_registration'])){
    ...
    $get_fullName = $_POST['user_name'];
    $get_email = $_POST['email'];
    $get_country = $_POST['countryCode'];
    $get_jobtype = $_POST['job_type'];
